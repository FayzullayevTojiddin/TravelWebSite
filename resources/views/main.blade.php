            ...
            <div>
               <div class="nav__menu" id="nav-menu">
                  <ul class="nav__list">
                     ...
                     <li class="nav__item">
                        <a href="./admin__blog.html" class="nav__link">Admin</a>
                     </li>

                     <li class="nav__item">
                        <a href="./Admin/login.html" class="nav__link">admin</a>
                     </li>
                  </ul>
         ...
         <section class="home section" id="home">
            ...
            <div class="home__container container grid">
               <div class="home__data">
                  <h3 class="home__subtitle">Sayohatga Hush  Kelibsiz</h3>

                  <h1 class="home__title">Dunyoni <br>  O'rganing</h1>

                  <p class="home__description">Dunyo bo'ylab sayohatlar bilan yashang, kashf eting
                     jannatlar, <br> orollar, tog'lar va boshqalar
                     ko'proq, sayohatingizni hoziroq oling.
                  </p>
            ...
            <div class="about__container container grid">
               <div class="about__data">
                  ...
                  <p class="about__description">
                     Dunyo bo'ylab barcha sayohatlar ajoyib <br>
                     har kim uchun zavq va baxt, rohatlaning <br>
                     dunyo bo'ylab sayohat qilganingizda <br> diqqatga sazovor joylar. Sayohat
                     xavfsiz va tashvishsiz, sayohatingizni oling va
                     dunyo jannatlarini o'rganing.
                  </p>
               ...
               <div class="explore__content container grid">
                  <div class="explore__data">
                     ...
                     <p class="explore__description">
                        Orollar va kabi jannatlarni o'rganish
                        dunyo bo'ylab sayohat qilganda vodiylardan biridir
                        sayohat qilganingizda eng katta tajribalar, bu
                        sizga uyg'unlik va tinchlik va sizni taklif qiladi
                        katta qulaylik bilan bahramand bo'lishi mumkin.
                     </p>  
                  </div>

                  <div class="explore__user">
                     <img src="assets/img/explore-perfil.png" alt="" class="explore__perfil">
                     <span class="explore__name">Ziyodullo web</span>
                  </div>
               </div>
            </div>
         </section>
               ...
               <div class="join__data">
                  ...
                  document.getElementById('contactForm')
                     .addEventListener('submit', function(e) {
                        e.preventDefault(); // Sayfa yangilanishini to‘xtatadi
         ...
         <div class="footer__container container grid">
            ...
            <div class="footer__group">
               ...
               <span class="footer__copy">
                  &#169; Mualliflik huquqi Bedimcode. Barcha huquqlar himoyalangan
               </span>
            </div>
         </div>
      </footer>
